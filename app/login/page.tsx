  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-blue-700 to-blue-500 rounded-2xl shadow-xl mb-6">
    ...
    <span className="text-white text-3xl font-black tracking-widest">
        PM
          ...
          <h1 className="text-5xl font-extrabold text-gray-900">Welcome to Partner Mobile</h1>
          <p className="text-gray-600 mt-2">Sign in to Partner Mobile CRM</p>
          <p className="text-sm text-blue-700 font-medium mt-2">
    Smart Devices • Connectivity • Digital Solutions
</p>
        </div>
